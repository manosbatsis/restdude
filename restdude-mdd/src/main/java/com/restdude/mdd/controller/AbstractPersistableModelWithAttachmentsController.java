...
public abstract class AbstractPersistableModelWithAttachmentsController<T extends PersistableModel<PK>, PK extends Serializable, S extends PersistableModelService<T, PK>>
        extends AbstractPersistableModelController<T, PK, S> {

	private static final Logger LOGGER = LoggerFactory.getLogger(AbstractPersistableModelWithAttachmentsController.class);
    ...
    public List<UploadedFileModel> getUploadsByProperty(@PathVariable PK subjectId,
														@PathVariable String propertyName) {
		LOGGER.info("uploadGet called");
		List<UploadedFileModel> uploads = null;
		// attach file
