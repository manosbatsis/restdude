...
/**
 * Abstract entity class with HATEOAS, basic auditing, unique constraints validation and authorization settings.
...
public abstract class AbstractPersistableResource<PK extends Serializable> extends ResourceSupport implements CalipsoPersistable<PK> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractPersistableResource.class);

    public AbstractPersistableResource() {
        super();
    }

    public AbstractPersistableResource(PK pk) {
        this.setPk(pk);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!AbstractPersistableResource.class.isAssignableFrom(obj.getClass())) {
            return false;
        }
        AbstractPersistableResource other = (AbstractPersistableResource) obj;
