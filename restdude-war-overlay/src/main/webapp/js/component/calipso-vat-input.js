...
define(['restdude'], function (Restdude) {
    ...
    Restdude.components.backboneform.VatNumberInput = Restdude.components.backboneform.Text.extend({
        initialize: function (options) {
            Restdude.components.backboneform.Text.prototype.initialize.call(this, options);
            var _this = this;
            ...
            options.schema.validators.push(function ensure(value, formValues) {
                ...
                if (value != null && value != "") {
                    ...
                    var msg = "";
                    if (!checkVATObject.valid_vat) {
                        msg += _this.labels.restdude.vatInput.invalidVat;
                    }
                    if (country && !checkVATObject.valid_country) {
                        msg += (" " + _this.labels.restdude.vatInput.countryMissmatch);
                        if (country) {
                            msg += (' (' + country + ')')
                        }
                    }
