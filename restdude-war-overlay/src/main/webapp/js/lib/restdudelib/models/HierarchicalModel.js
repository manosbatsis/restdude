...
define(['jquery', 'underscore', 'bloodhound', 'typeahead', "lib/restdudelib/util", "lib/restdudelib/form",
    ...
    function ($, _, Bloodhoud, Typeahead, Restdude, RestdudeForm, RestdudeField, RestdudeGrid, RestdudeView, Handlebars) {
        /**
         * Model for internet hierarchicals
         * @name Restdude.model.HierarchicalModel
         * @constructor
         * @augments Caliopso.Model
         */
        Restdude.model.HierarchicalModel = Restdude.Model.extend(
            /** @lends Restdude.model.HierarchicalModel.prototype */
            {
                toString: function () {
                ...
                pathFragment: "hierarchicals",
                typeName: "Restdude.model.HierarchicalModel",
                menuConfig: null,
                fields: {
                    name: {
                        fieldType: "String",
