...
public interface ClientErrorRepository extends CaseNoRepositoryBean<ClientError> {
    ...
    List<CaseCommenttInfo> getCompactCommentsBySubject(@P("parent") @Param("parent") ClientError parent);
}
