...
@RestController
@RequestMapping(value = "/api/rest/"+BaseError.API_PATH)
public class BaseErrorController extends AbstractPersistableModelController<BaseError, String, BaseErrorService> {

    /**
     * {@inheritDoc}
     */
    @Override
    public BaseError create(@RequestBody BaseError resource) {
    ...
    public BaseError updateFiles(@PathVariable String id,
