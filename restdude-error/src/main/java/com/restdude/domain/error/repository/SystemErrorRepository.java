...
public interface SystemErrorRepository extends AbstractCaseModelRepository<SystemError> {
    ...
    List<CaseCommenttInfo> getCompactCommentsBySubject(@P("subject") @Param("subject") SystemError subject);
}
