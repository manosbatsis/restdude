...
TestCase.prototype.async$F$LAsyncContext$V$F$LAsyncContext$V$I = function (testBody, timeoutHandler, timeoutMS) {
	...
	async = new AsyncContext(this, (function (v) {
		if (! (v != null)) {
			debugger;
			throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:194:47] null access\n        var async = new AsyncContext(this, this._currentName, timeoutHandler, timeoutMS);\n                                               ^\n");
		}
		return v;
...
TestCase.prototype._ok$US = function (name) {
	...
	s = (name != null ? " - " + (function (v) {
		if (! (v != null)) {
			debugger;
			throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:231:39] null access\n        var s = name != null ? \" - \" + name :  \"\";\n                                       ^^^^\n");
		}
		return v;
	}(name)) : "");
...
TestCase.prototype._nok$USUSXX = function (name, op, got, expected) {
	...
	s = (name != null ? " - " + (function (v) {
		if (! (v != null)) {
			debugger;
			throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:246:39] null access\n        var s = name != null ? \" - \" + name :  \"\";\n                                       ^^^^\n");
		}
		return v;
	}(name)) : "");
	...
	if (op != null) {
		this.diag$S("comparing with " + (function (v) {
			if (! (v != null)) {
				debugger;
				throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:250:42] null access\n            this.diag(\"comparing with \" + op + s.replace(\" - \", \" for \"));\n                                          ^^\n");
			}
			return v;
		}(op)) + s.replace(" - ", " for "));
	...
	throw new TestCase$x2EFailure((function (v) {
		if (! (v != null)) {
			debugger;
			throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:254:48] null access\n        throw new TestCase.Failure(name != null ? name : \"\");\n                                                ^\n");
		}
		return v;
	}(name != null ? name : "")));
};
	...
	if (a instanceof Array) {
		...
		aryA = (function ($v) {
			if (! ($v == null || $v instanceof Array)) {
				debugger;
				throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:306:25] detected invalid cast, value is not an Array or null\n            var aryA = a as Array.<variant>;\n                         ^^\n");
			}
			return $v;
		}(a));
		aryB = (function ($v) {
			if (! ($v == null || $v instanceof Array)) {
				debugger;
				throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:307:25] detected invalid cast, value is not an Array or null\n            var aryB = b as Array.<variant>;\n                         ^^\n");
			}
			return $v;
		}(b));
	...
	if ((typeof(a) === "object")) {
		...
		mapA = (function ($v) {
			if (! ($v == null || typeof $v === "object" || typeof $v === "function")) {
				debugger;
				throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:324:25] detected invalid cast, value is not a Map or null\n            var mapA = a as Map.<variant>;\n                         ^^\n");
			}
			return $v;
		}(a));
		mapB = (function ($v) {
			if (! ($v == null || typeof $v === "object" || typeof $v === "function")) {
				debugger;
				throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:325:25] detected invalid cast, value is not a Map or null\n            var mapB = b as Map.<variant>;\n                         ^^\n");
			}
			return $v;
		}(b));
	...
	if (a instanceof Date) {
		...
		dateA = (function ($v) {
			if (! ($v == null || $v instanceof Date)) {
				debugger;
				throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:351:26] detected invalid cast, value is not an instance of the designated type or null\n            var dateA = a as Date;\n                          ^^\n");
			}
			return $v;
		}(a));
		dateB = (function ($v) {
			if (! ($v == null || $v instanceof Date)) {
				debugger;
				throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:352:26] detected invalid cast, value is not an instance of the designated type or null\n            var dateB = b as Date;\n                          ^^\n");
			}
			return $v;
		}(b));
		if (dateA && dateB) {
...
TestCase.prototype.difflet$AXAX = function (a, b) {
	...
	if (! (a != null)) {
		debugger;
		throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:363:17] assertion failure\n        assert a != null;\n                 ^^\n");
	}
	if (! (b != null)) {
		debugger;
		throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/common/test-case.jsx:364:17] assertion failure\n        assert b != null;\n                 ^^\n");
	}
	s = "[\n";
...
function Timer$setTimeout$F$V$N(callback, intervalMS) {
	return (function ($v) {
		if (! ($v == null || typeof $v === "function")) {
			debugger;
			throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:34:40] detected invalid cast, value is not a function or null\n        return (js.global[\"setTimeout\"] as __noconvert__ function(:function():void,:number) : TimerHandle)(callback, intervalMS);\n                                        ^^\n");
		}
		return $v;
...
function Timer$clearTimeout$LTimerHandle$(timer) {
	(function ($v) {
		if (! ($v == null || typeof $v === "function")) {
			debugger;
			throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:38:35] detected invalid cast, value is not a function or null\n        (js.global[\"clearTimeout\"] as __noconvert__ function(:TimerHandle) : void)(timer);\n                                   ^^\n");
		}
		return $v;
...
function Timer$setInterval$F$V$N(callback, intervalMS) {
	return (function ($v) {
		if (! ($v == null || typeof $v === "function")) {
			debugger;
			throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:42:41] detected invalid cast, value is not a function or null\n        return (js.global[\"setInterval\"] as __noconvert__ function(:function():void,:number) : TimerHandle)(callback, intervalMS);\n                                         ^^\n");
		}
		return $v;
...
function Timer$clearInterval$LTimerHandle$(timer) {
	(function ($v) {
		if (! ($v == null || typeof $v === "function")) {
			debugger;
			throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:46:36] detected invalid cast, value is not a function or null\n        (js.global[\"clearInterval\"] as __noconvert__ function(:TimerHandle) : void)(timer);\n                                    ^^\n");
		}
		return $v;
	...
	if (useNativeImpl) {
		...
		for (i = 0; i < prefixes.length; ++i) {
			name = (function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:72:35] null access\n                var name = prefixes[i] + \"equestAnimationFrame\";\n                                   ^\n");
				}
				return v;
			...
			if (js$0.global[name] instanceof Function) {
				return (function (callback) {
					return (function ($v) {
						if (! ($v == null || typeof $v === "function")) {
							debugger;
							throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:75:48] detected invalid cast, value is not a function or null\n                        return (js.global[name] as __noconvert__\n                                                ^^\n");
						}
						return $v;
	...
	if (useNativeImpl) {
		...
		for (i = 0; i < prefixes.length; ++i) {
			name = (function (v) {
				if (! (v != null)) {
					debugger;
					throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:100:35] null access\n                var name = prefixes[i] + \"ancelAnimationFrame\";\n                                   ^\n");
				}
				return v;
			...
			if (js$0.global[name] instanceof Function) {
				return (function (timer) {
					(function ($v) {
						if (! ($v == null || typeof $v === "function")) {
							debugger;
							throw new Error("[/Users/yosuke/Program/grunt-jsx/node_modules/jsx/lib/js/timer.jsx:103:41] detected invalid cast, value is not a function or null\n                        (js.global[name] as __noconvert__\n                                         ^^\n");
						}
						return $v;
