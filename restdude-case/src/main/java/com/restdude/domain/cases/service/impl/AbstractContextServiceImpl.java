...
@Slf4j
public abstract class AbstractContextServiceImpl<T extends MembershipContext, R extends ContextRepository<T>>
    ...
    public Page<MembershipContextInfo> findVisible(Pageable pageable) {
    ...
    @Override
    @PreAuthorize(SpelUtil.HAS_ROLE_USER)
    public Page<MembershipContextInfo> findMy(Pageable pageable) {
