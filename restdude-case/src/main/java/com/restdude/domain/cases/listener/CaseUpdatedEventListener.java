...
@Slf4j
//@Component
public class CaseUpdatedEventListener extends AbstractEventListener<AbstractCase> {//implements ApplicationListener<EntityUpdatedEvent<AbstractCase>> {



	@EventListener
	public void onApplicationEvent(EntityUpdatedEvent<AbstractCase> event) {
