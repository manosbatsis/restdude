...
public interface BusinessContextMembersActivityMessanger {
	 ...
	 */
	default void sendStompActivityMessageToMembers(IActivityNotificationMessage msg, MembershipContext businessContext) {
	 ...
	 */
	default void sendStompActivityMessageToMembers(IActivityNotificationMessage msg, MembershipContext businessContext, List<String> cc) {
