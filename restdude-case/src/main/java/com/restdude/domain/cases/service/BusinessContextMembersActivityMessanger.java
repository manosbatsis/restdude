...
public interface BusinessContextMembersActivityMessanger {
	 ...
	 */
	default void sendStompActivityMessageToMembers(IActivityNotificationMessage msg, BaseContext businessContext) {
	 ...
	 */
	default void sendStompActivityMessageToMembers(IActivityNotificationMessage msg, BaseContext businessContext, List<String> cc) {
