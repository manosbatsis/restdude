...
@ApiModel(value = "Space invitation list results", description = "SpaceInvitationsResult is a model reporting  the submission results (see properties).")
public class SpaceInvitationsResult implements Serializable {
	...
	public static class Builder {
		...
		public SpaceInvitationsResult build() {
			return new SpaceInvitationsResult(this);
		}
	}

	private SpaceInvitationsResult(Builder builder) {
